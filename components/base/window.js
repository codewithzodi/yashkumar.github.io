...
export class Window extends Component {
    ...
    componentDidMount() {
        ...
        this.centered = this.props.centered || false;
    ...
    setDefaultWindowDimenstion = () => {
        ...
        if (window.innerWidth < 640) {
            w = this.props.initialWidth || 85;
            h = this.props.initialHeight || 60;
        } else {
            w = this.props.initialWidth || 60;
            h = this.props.initialHeight || 85;
        }
        if (this.centered) {
            // Center the window on screen
            this.startX = (window.innerWidth - (window.innerWidth * w / 100)) / 2;
            this.startY = (window.innerHeight - (window.innerHeight * h / 100)) / 2 - 28;
        }
        this.setState({ height: h, width: w }, this.resizeBoundries);
    }
